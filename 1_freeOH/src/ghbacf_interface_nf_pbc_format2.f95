      ...
      REAL(KIND=rk), PARAMETER :: cosPhiC123=0.643             !  phiC= 50 (degree).
      REAL(KIND=rk), PARAMETER :: cosPhiC132=-0.342            !  phiC132= 110 (degree).
     ...
     !=============      
      ...
      !==============================
      corr_h = corr_h/(REAL( num_start_points * nwat,rk)*ave_h)
     ...
     !===================================
      ...
      OPEN(10,file=trim(filename)//'_acf_NF_' &
        //char_thickness//'.dat')
     ...
     ! Print <h>      
     !===========      
      OPEN(10,file=trim(filename)//'_wat_pair_ave_NF_ihb_'//&
        char_thickness//'.dat')
